    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(verbose_name="last name", max_length=150, blank=True)),
                ('email',models.EmailField(unique=True, error_messages={"unique": ("A user with that username already exists.")})),
                ('age', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(limit_value=100)])),
